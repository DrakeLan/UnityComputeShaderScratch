...
public class SkinnedFlocking : MonoBehaviour {
    ...
    private void GenerateVertexAnimationBuffer()
    {
        ...
        Vector4[] vertexAimationData = new Vector4[vertexCount * numOfFrames];
        ...
        for(int i=0; i<numOfFrames; i++){
            ...
            for(int j=0; j< vertexCount; j++){
                ...
                vertex.w = 1;
                vertexAimationData[j * numOfFrames + i] = vertex;
        ...
        vertexAnimationBuffer.SetData(vertexAimationData);
